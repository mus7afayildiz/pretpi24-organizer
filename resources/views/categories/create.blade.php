            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                <div class="font-semibold dark:text-white leading-tight text-gray-800">
                        <form method="POST" action="{{ route('categories.store') }}"> 
                            ...
                            <input type="text" name="name" id="name" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white"> 
                            </div>
